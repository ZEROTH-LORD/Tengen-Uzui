...
from TengenUzui import DB_NAME, LOGGER, MONGO_DB_URI

try:
    TengenUzui_db_client = MongoClient(MONGO_DB_URI)
except PyMongoError as f:
    LOGGER.error(f"Error in Mongodb: {f}")
    exiter(1)
TengenUzui_main_db = TengenUzui_db_client[DB_NAME]
...
class MongoDB:
    ...
    def __init__(self, collection) -> None:
        self.collection = TengenUzui_main_db[collection]
    ...
    @staticmethod
    def close():
        return TengenUzui_db_client.close()
