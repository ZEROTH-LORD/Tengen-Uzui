...
from TengenUzui.plugins import ALL_MODULES
from TengenUzui.plugins.helper_funcs.chat_status import is_user_admin
from TengenUzui.plugins.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("TengenUzui.plugins." + module_name)
...
async def gitsource_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "git_source":
        source_link = "https://github.com/ZEROTH-LORD/TengenUzui"
        message_text = (
...
def main():
    ...
    LOGGER.info("TengenUzui is starting >> Using long polling.")
