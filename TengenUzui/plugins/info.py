...
from ZEROTH.karma import START_IMG
from TengenUzui import DEV_USERS, DRAGONS, INFOPIC, OWNER_ID, function
from TengenUzui.__main__ import STATS, USER_INFO
from TengenUzui.plugins.helper_funcs.chat_status import support_plus, dev_plus
from TengenUzui.plugins.users import get_user_id
...
async def info(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if chat_obj.type == ChatType.PRIVATE:
        ...
        if chat_obj.id == OWNER_ID:
            ...
            head += "\n\n🐉 <b>This user is a member of ZEROTH Hydra.</b>"
            disaster_level_present = True
