...
from ZEROTH.temp import temp
from TengenUzui import DEV_USERS
from TengenUzui import DEV_USERS as SUDO
from TengenUzui import DRAGONS, EVENT_LOGS, LOGGER, OWNER_ID, app, dispatcher, function
from TengenUzui.plugins.helper_funcs.chat_status import check_admin, is_user_ban_protected
from TengenUzui.plugins.helper_funcs.misc import build_keyboard, revert_buttons
from TengenUzui.plugins.helper_funcs.msg_types import get_welcome_type
from TengenUzui.plugins.helper_funcs.string_handling import escape_invalid_curly_brackets
from TengenUzui.plugins.log_channel import loggable
from TengenUzui.utils.can_restrict import can_restrict
...
async def new_member(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    for new_mem in new_members:
        if new_mem.id == bot.id and not TengenUzui.ALLOW_CHATS:
